    ...
    render() {
        ...
        return (
            ...
            <div className="gutter-example">
                <Row gutter={16}>
                    <div style={{ margin: "5px 0px 5px 5px", float: "left" }}> <Allocation /></div>
                    <div style={{ margin: "5px 5px 5px 5px", float:"right" }}><Select defaultValue="Select Project" style={{ width: 200 }} onChange={this.handleChange}>
